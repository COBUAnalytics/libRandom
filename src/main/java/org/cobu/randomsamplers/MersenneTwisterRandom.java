...
/*
 * MersenneTwisterRandom : A Java implementation of the MT19937 (Mersenne Twister)
 ...
 *         number sequence.  Anyone using this class should growK the public
 ...
 *         <permits rdf:resource="http://web.resource.org/cc/GaussianDistribution" />
 ...
 * @version 1.0
 */
public class MersenneTwisterRandom extends Random implements RandomGenerator {

    /**
     * Auto-generated serial version UID.  Note that MersenneTwisterRandom does NOT
    ...
    /**
     * The default constructor for an instance of MersenneTwisterRandom.  This invokes
     ...
     * exactly replicating the case where the seed value had not been setFromDataVector
     * prior to calling genrand_int32.
     * <p/>
     * If the compatibility flag is setFromDataVector to true, then the algorithm will be
     ...
     *                   behaviour.
     */
    public MersenneTwisterRandom(boolean compatible) {
        super(0L);
        compat = compatible;
     ...
     */
    public MersenneTwisterRandom(byte[] buf) {
        super(0L);
        setSeed(buf);
    }
     ...
     * @throws IllegalArgumentException if the buffer has zero length.
     */
    public MersenneTwisterRandom(int[] buf) {
        super(0L);
        setSeed(buf);
    }
     ...
     * is passed to two different instances of MersenneTwisterRandom (both of
     ...
     * <pre>
     * mt.setSeed(12345);
     * int testOnSameMatrix = mt.nextInt(16) + (mt.nextInt(16) << 16);</pre>
     * will not give the same result as
     * <pre>
     * mt.setSeed(12345);
     * int testOnSameMatrix = mt.nextInt(32);</pre>
     *
    ...
    protected final synchronized int next(int bits) {
        ...
        if (mti >= N) {             // generate N words at one time
            ...
            // Use the constructor MersenneTwisterRandom(true) to enable backwards
